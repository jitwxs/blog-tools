var pinyin1 = $("#pinyin_textarea_1");
var pinyin2 = $("#pinyin_textarea_2");

function convert_pinyin() {
	var cc = pinyin1.val();
...
function clear_pinyin() {
	pinyin1.val("");
	pinyin2.val("");
}

var complex1 = $("#complex_textarea_1");
var complex2 = $("#complex_textarea_2");
...
function convert_simple() {
	var content = complex1.val();
	complex2.val(simplized(content));
}

function convert_complex() {
	var content = complex1.val();
	complex2.val(traditionalized(content));
}

function clear_complex() {
	complex1.val("");
	complex2.val("");
}

var number1 = $("#number_textarea_1");
var number2 = $("#number_textarea_2");

function convert_capital() {
	var currencyDigits = number1.val();
...
// Process the coversion from currency digits to characters: 
	...
	number2.val(outputCharacters);
}

function convert_number() {
	var content = number1.val();
